...
const EndSection: FC<EndSectionProps> = ({ }) => {
    return (
        <div className="w-[1112px] h-[647px] relative">
            ...
            <div className="w-[730px] h-[454px] bg-[#34053e] p-[64px] flex flex-col items-start gap-[32px] absolute bottom-[32px] right-0">
                ...
                <p className='text-white text-[18px] w-[602px] leading-[32px]'>Hi, I'm Louis Graham, the founder of the company. Book a demo call with me to become a beta tester for our app and kickstart your company. Apply for access below and I’ll be in touch to schedule a call.</p>
